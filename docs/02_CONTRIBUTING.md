...
* **Bootstrap**: Use `./scripts/cluster/up-local-libvirt.sh` to recreate the local lab.
...
* **Deployment**: Runtime manifests live under `deploy/stage3/` and `deploy/charts/model-service-stage3/`.
